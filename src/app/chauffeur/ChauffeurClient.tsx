...
export default function ChauffeurClient({ initialCars, initialCities }: { initialCars: any[], initialCities: any[] }) {
  ...
  return (
    <div className="container mx-auto px-4">
      {/* Header Section */}
      <div className="bg-[#111111] border border-white/5 rounded-3xl p-10 mb-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 pb-8 border-t border-white/5 mb-6">
          <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-white/70">
            <BadgeCheck className="text-brand-neon" size={18} /> Certified Drivers
          </div>
          <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-white/70">
            <ShieldCheck className="text-brand-neon" size={18} /> 100% Insured Trips
          </div>
          <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-white/70">
            <MapPin className="text-brand-neon" size={18} /> All-Inclusive Tolls
          </div>
          <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-white/70">
            <Clock className="text-brand-neon" size={18} /> 24/7 Priority Ingress
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-white/5">
              <div className="flex justify-between items-center mb-4">
                <label className="block text-[10px] text-white/50 font-bold uppercase tracking-widest">Max Fare</label>
