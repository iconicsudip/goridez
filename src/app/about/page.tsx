...
export default async function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-body pb-24">
      {/* Hero Banner */}
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center mt-16 max-w-3xl">
          ...
          <p className="text-white/60 text-sm md:text-base font-mono max-w-xl mx-auto leading-relaxed">
            {subtitle}
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 -mt-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-[#111111] border border-white/5 p-8 md:p-12 rounded-3xl shadow-2xl">
            <div
          ...
          <div className="space-y-6">
            <div className="bg-[#111111] border border-white/5 p-8 rounded-3xl">
              <div className="w-10 h-10 rounded-2xl bg-brand-neon/10 border border-brand-neon/20 flex items-center justify-center mb-6">
                <Shield className="text-brand-neon" size={20} />
              </div>
            ...
            {/* CTA */}
            <div className="bg-gradient-to-r from-brand-neon/20 to-emerald-500/10 border border-brand-neon/30 p-8 rounded-3xl flex flex-col justify-between">
              <div>
                <h3 className="text-sm font-black uppercase tracking-widest text-white mb-2">
                  Plan Your Odyssey
                </h3>
                <p className="text-[11px] text-white/60 leading-relaxed mb-6 font-mono">
                  Book a premium drive or tour excursion now with our instant booking widget.
                </p>
              </div>
              <Link
                href="/"
                className="w-full bg-brand-neon text-black text-center py-3.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-brand-hover transition-colors"
              >
                Go to Booking Desk
              </Link>
            </div>
