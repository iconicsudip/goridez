    ...
    <>
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <p className="text-[10px] text-white/40 font-mono tracking-widest uppercase">Configure mileage tier rates, standard features, and retire vehicles instantly.</p>
        </div>
