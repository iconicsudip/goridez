        ...
        <div className="p-8 md:p-10">
          <div className="flex justify-between items-center mb-10">
            <h2 className="text-sm font-black uppercase tracking-widest flex items-center gap-2">
              <span className="text-green-700">{route ? '✎' : '+'}</span> {route ? 'EDIT ROUND TRIP ROUTE' : 'ADD ROUND TRIP ROUTE'}
            </h2>
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <select name="cityId" required defaultValue={route?.cityId || ''} className="w-full bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 text-xs text-gray-900 outline-none font-mono focus:border-green-600/40 transition-colors appearance-none">
                ...
                <div className="space-y-2">
                  <label className="text-[9px] text-gray-500 font-mono uppercase tracking-widest block">Distance (KM) *</label>
              ...
              <div className="space-y-2">
                <label className="text-[9px] text-gray-500 font-mono uppercase tracking-widest block">Route Title *</label>
                <input name="routeTitle" type="text" required defaultValue={route?.routeTitle || ''} placeholder="e.g. Udaipur - Kumbhalgarh"
                  className="w-full bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 text-xs text-gray-900 outline-none font-mono focus:border-green-600/40 transition-colors" />
              </div>
              <div className="space-y-2">
                <label className="text-[9px] text-gray-500 font-mono uppercase tracking-widest block">Night Allowance (₹) *</label>
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                {[
                  ...
                  <div key={cat.prefix} className="mb-6 bg-gray-100 p-5 rounded-2xl border border-gray-200">
                    <h3 className="text-[10px] font-bold text-gray-900 mb-4 uppercase tracking-widest">{cat.label} Pricing</h3>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="space-y-2">
                        <label className="text-[9px] text-gray-500 font-mono uppercase tracking-widest block">1 Day (₹)</label>
                      ...
                      <div className="space-y-2">
                        <label className="text-[9px] text-gray-500 font-mono uppercase tracking-widest block">2 Days (₹)</label>
                        <input name={`${cat.prefix}2D`} type="number" required defaultValue={route?.[`${cat.prefix}2D`] || ''} placeholder="0"
                          className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-xs text-gray-900 outline-none font-mono focus:border-green-600/40 transition-colors" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-[9px] text-gray-500 font-mono uppercase tracking-widest block">3 Days (₹)</label>
